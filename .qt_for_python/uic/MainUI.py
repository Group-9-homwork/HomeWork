...
# Form implementation generated from reading ui file 'd:\group9homework\HomeWork\code\MainUI.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.remark_lW_list.setColumnWidth(0, 850)
        ...
        self.ana_l_pie = QtWidgets.QLabel(self.analyze)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ana_l_pie.sizePolicy().hasHeightForWidth())
        self.ana_l_pie.setSizePolicy(sizePolicy)
        self.ana_l_pie.setMinimumSize(QtCore.QSize(400, 0))
        self.ana_l_pie.setObjectName("ana_l_pie")
        self.ana_hL_5.addWidget(self.ana_l_pie)
        self.ana_lW_message = QtWidgets.QListWidget(self.analyze)
        self.ana_lW_message.setObjectName("ana_lW_message")
        self.ana_hL_5.addWidget(self.ana_lW_message)
        self.ana_vL_2.addLayout(self.ana_hL_5)
        spacerItem3 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.ana_vL_2.addItem(spacerItem3)
        self.ana_hL_6 = QtWidgets.QHBoxLayout()
        self.ana_hL_6.setContentsMargins(-1, -1, 700, -1)
        self.ana_hL_6.setObjectName("ana_hL_6")
        self.ana_l_save = QtWidgets.QLabel(self.analyze)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ana_l_save.sizePolicy().hasHeightForWidth())
        self.ana_l_save.setSizePolicy(sizePolicy)
        self.ana_l_save.setMinimumSize(QtCore.QSize(89, 0))
        self.ana_l_save.setObjectName("ana_l_save")
        self.ana_hL_6.addWidget(self.ana_l_save)
        self.ana_lE_savepath = QtWidgets.QLineEdit(self.analyze)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ana_lE_savepath.sizePolicy().hasHeightForWidth())
        self.ana_lE_savepath.setSizePolicy(sizePolicy)
        self.ana_lE_savepath.setMinimumSize(QtCore.QSize(250, 0))
        self.ana_lE_savepath.setObjectName("ana_lE_savepath")
        self.ana_hL_6.addWidget(self.ana_lE_savepath)
        self.ana_pB_yes = QtWidgets.QPushButton(self.analyze)
        self.ana_pB_yes.setObjectName("ana_pB_yes")
        self.ana_hL_6.addWidget(self.ana_pB_yes)
        self.ana_vL_2.addLayout(self.ana_hL_6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.spi_pB_yes.setText(_translate("MainWindow", "确认"))
        ...
        self.ana_l_pie.setText(_translate("MainWindow", "饼状图"))
        self.ana_l_save.setText(_translate("MainWindow", "保存路径："))
        self.ana_lE_savepath.setPlaceholderText(_translate("MainWindow", "例如：D:/data/data.csv"))
