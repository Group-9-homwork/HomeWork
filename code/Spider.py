...
class SpiderModule():
    ...
    def initArgs(self):
        ...
        self.query['symbol'] = "SH603517"
        self.baseUrl = 'https://xueqiu.com/query/v1/symbol/search/status?'
    ...
    def spiderStart(self):
        ...
        self.ui.spi_pB_stop.clicked.connect(self.stopCrawler)
        # 修改linetext的内容就会发生cur归1
        self.ui.spi_lE_stock.textChanged.connect(self.changeCur)
        self.ui.spi_lE_path.textChanged.connect(self.changeCur)
